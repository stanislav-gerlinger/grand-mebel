...
<main style="background: #FFFFFF;">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./assets/images/slider-img-3.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img src="./assets/images/slider-img-1.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Природа 2</h5>
                ...
                <div class="carousel-item">
                    <img src="./assets/images/slider-img-2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Природа 3</h5>
    ...
    <section class="categories" style="padding-top: 60px; padding-bottom: 50px;">
        <div class="container">
            <div class="row">
