        ...
        <div class="row">
            <div class="col-sm-1">
                <a href="http://grand-mebel.loc/">
                    <img title="Логотип" src="https://image.freepik.com/free-vector/creative-furniture-logo-template_23-2148466513.jpg" height="100px">
                </a>
            </div>
            <div class="col-sm-5">
                <div><h2>ГРАНД</h2></div>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="http://grand-mebel.loc/product-category/dvp/">ДВП (1,7*2,75)</a>
                            <a class="dropdown-item" href="http://grand-mebel.loc/product-category/dsp-16mm/">ДСП 16мм Кроностар</a>
                        </div>
                    </li>
                    <li class="nav-item">
